...
define ("VICTIM","冤死鬼:身份【神】,阵营【人类】,技能【当冤死鬼白天死亡时,将立刻再进行一次投票,没有讨论发言,直接投票,票高者死亡,平票或无人投票则投票阶段结束.当冤死鬼夜里被狼刀死时,可以指定一名玩家发起一次决斗,如果该玩家身份为狼人,则该玩家一同死亡,否则冤死鬼自己死亡】");
define ("AGENT","特工:身份【神】,阵营【人类】,技能【首夜特工指定一名玩家,该玩家死亡后,特工觉醒,觉醒后的特工每晚可以选择1.杀死一名玩家\n2.查看一名玩家是否与自己是同一阵营\n特工夜里死亡不能发动技能\n特殊描述:在人数较少的游戏里(建议6人或以下),特工首夜指定玩家为狼,则特工变成狼人,否则特工可以和首夜指定的玩家作为特工阵营,胜利条件为白天睁眼后场上剩余两名或以下玩家里有特工阵营的玩家且另一名玩家既不是村民也不属于狼阵营时胜利】");
