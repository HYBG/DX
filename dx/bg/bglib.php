...
define ("MENU_DEFAULT","输入\"角色\"查看所有特殊角色,输入\"狼人杀\"创建新游戏,输入\"重置\"恢复初始状态,输入房间号进入游戏");
define ("LADYW","狼美人:身份【狼】,阵营【狼人】,技能【晚上魅惑一名玩家，白天狼美人被投票放逐时，该玩家殉情而死】");
define ("HUNTERW","狼枪:身份【狼】,阵营【狼人】,技能【符合死亡条件时,可以射杀一名玩家,无特殊情况该玩家死亡】");
define ("SPY","间谍:身份【神】,阵营【狼人】,技能【针对狼人身份的技能对间谍均无效,夜晚间谍和狼人一起睁眼杀人】");
define ("HACKER","黑客:身份【狼】,阵营【狼人】,技能【每天晚上可以选择一名玩家,执行下面一项1:篡改该玩家的身份,狼变为神,神/民变为狼,白天自动恢复;2:该玩家白天的放逐投票从-2票开始计数,最小为零,每名玩家每局只能指定一次,上帝会在投票后宣布谁的票被改变了.】");
...
define ("KINGH","国王:身份【神】,阵营【人类】,技能【在放逐发言阶段,国王可以选择亮明身份,身份亮明以后可以二选一行使王权,1:特赦一名玩家,该玩家在当天所有的放逐阶段得票均计算为零.2:在所有投票阶段的票权为2.国王死后,如果场上有警长,可以选择罢免警长或任命一个警长以外的玩家为摄政王,摄政王的票权为1.6,摄政王不能接受警徽,如果场上没有警长,可以任命一个警长.如果国王死在夜里,且任命了警长,警长当天白天可以进行一次临时查牌,查验一名玩家的底牌,如果摄政王死在夜里,且有警长在场,警长当天白天也获得一次临时查牌权力.临时查牌是查看玩家身份,上帝报出所有角色,给出精确身份】");
...
define ("VICTIM","冤死鬼:身份【神】,阵营【人类】,技能【当冤死鬼白天被放逐或枪杀死亡时,将立刻再进行一次投票,没有讨论发言,直接投票,票高者死亡,平票或无人投票则投票阶段结束.冤死鬼每晚指定一名玩家,如果冤死鬼夜里被狼刀死或枪杀或由多于一种原因致死时,该玩家将在下一个夜晚死亡,上帝只会宣布死亡玩家的号码,不会给出其他信息】");
define ("AGENT","特工:身份【神】,阵营【人类】,技能【首夜特工指定三名其他玩家,每当有一名玩家死亡，特工解锁一项技能1.晚上查看一名玩家是否和自己同一阵营\n2.晚上可以守卫一名玩家免于狼刀伤害,不能连续守卫同一玩家\n3.晚上选择一名玩家暗杀\n特工每晚只能使用最多一项技能,特工夜里死亡不能发动技能\n六人局特殊描述:特工首夜指定一名玩家，如果玩家为狼,则特工变成狼人,否则特工可以和首夜指定的玩家作为特工阵营,该玩家死亡后,特工每天晚上可以选择暗杀一名玩家.胜利条件为白天睁眼后场上剩余两名或以下玩家里有特工阵营的玩家且另一名玩家既不是村民也不属于狼阵营时胜利】");
define ("WORKER","工作狂:身份【神】,阵营【人类】,技能【每晚选择一个玩家,如果该玩家在白天投票阶段还活着,在白天任何阶段的票,只要可以投票有效,加班狂的票必须投给该玩家,否则必须弃票,加班狂晚上被刀,被毒,被枪击均无效,工作狂可以上警,但必须退水,不能主动拿警徽,但可以继承或被任命】");
define ("HERO","义士:身份【神】,阵营【人类】,技能【每晚可以选定一个角色,如果此人晚上死去,则义士代替其死去,在白天投票结束时,如果出现被放逐的玩家后,义士可以代替其被放逐,无论白天夜间义士死时都可以发表遗言】");
define ("DETECTIVE","侦探:身份【神】,阵营【人类】,技能【每天晚上可以选择向上帝下列问题中的一个,上帝给出相应的手势\n1.他是否属于狼人阵营?\n2.他是否拥有特殊技能?\n3.场上还有几个狼阵营的玩家?\n提示:当有招魂师在场,计算阵营人数时,以\"尸\"的阵营为准;除普通狼人和村民外的角色视为有特殊技能.】");
...
define ("DEMON","恶灵骑士:身份【狼】,阵营【狼人】,技能【晚上同狼人一同杀人,如果晚上被预言家查验,预言家死,被女巫毒,女巫死,同验同毒,预言家死,女巫不死.技能只能发动一次,不能自刀】");
define ("CHARITARIAN","慈善家:身份【人】,阵营【人类】,技能【慈善家平时积德行善,免于一次夜间死亡,枪杀不能幸免】");
define ("RICH","富豪:身份【人】,阵营【人类】,技能【每晚指定一名玩家,该玩家次日白天的投票均计为零,每名玩家只能被指定一次】");
...
class bglib{
    ...
    private $godcommands = array("command_100","command_101","command_102");
    private $roles = array("狼王"=>KINGW,"梦魇"=>NIGHTMARE,"狼美人"=>LADYW,"狼枪"=>HUNTERW,"间谍"=>SPY,"黑客"=>HACKER,"预言家"=>TELLER,"女巫"=>WITCH,"猎人"=>HUNTERH,"守卫"=>KEEPER,"白痴"=>FOOL,"骑士"=>KNIGHT,"摄梦人"=>DREAMTAKER,"魔术师"=>MAGICIAN,"国王"=>KINGH,"侍卫"=>GUARD,"招魂师"=>SPIRITIST,"冤死鬼"=>VICTIM,"特工"=>AGENT,"工作狂"=>WORKER,"义士"=>HERO,"侦探"=>DETECTIVE,"混子"=>MUGWUMP,"丘比特"=>CUPID,"盗贼"=>THIEF,"熊"=>BEAR,"狐狸"=>FOX,"恶灵骑士"=>DEMON,"慈善家"=>CHARITARIAN,"富豪"=>RICH);
    ...
    function __construct(){
        ...
        $this->shortcut["8a"] = array(array("女巫","猎人","预言家","盗贼"),3,3,true);
        $this->shortcut["8b"] = array(array("女巫","猎人","魔术师","盗贼"),3,3,true);
            ...
            if (count($roles)==0){
                ...
                if (count($ids)==0){
                    ...
                    for($i=0;$i<count($roles);$i++){
                        array_push($sqls,"insert into bg_game(roomid,seatid,role,live) values('".$roomid."',".($i+1).",'".$roles[$i]."','存活')");
                    }
                    if ($hasthief){
        ...
        if ($status==101){
            ...
            elseif (($key=="配置") or ($key=="板子")){
                ...
                if (!empty($ids[0])){
                    ...
                    $hasch = $this->exe_sql_one("select count(*) from bg_game where roomid='".$ids[1]."' and status=2");
    ...
    private function handle_102($key,$from,$status){
        ...
        if ($status==102){
            ...
            elseif($key=="指令"){
                $content = "100 当前阶段 #设置当前阶段\n";
                $content = $content."101 seatid 死亡类型 死亡时间#设置死亡玩家\n";
            }
            else{
                $content = $this->execmd($key,$from);
                if ($content==""){
                    $content = GODMENU;
                }
            }
    ...
    private function abst($from){
        ...
        $infs = $this->exe_sql_batch("select seatid,role,player from bg_game where roomid='".$rid[0]."' order by seatid");
        foreach($infs as $inf){
        ...
        $stages = $this->exe_sql_batch("select distinct stage from bg_game where roomid='".$rid[0]."' and seatid!=0 order by stage");
        foreach($stages as $sg){
            $sgname = $this->exe_sql_one("select name from bg_stage where id='".$sg[0]."'");
            $content = $content.$sgname[0].":\n";
            $deathinfo = $this->exe_sql_batch("select player,role,live from bg_game where stage=".$sg[0]);
            foreach($deathinfo as $di){
                $content = $content.$di[0]."-".$di[1]."-".$di[2]."\n";
            }
        }
        $content = $content."\n";
        $content = $content."笔记\n";
    ...
    private function command_100($from,$cmd){
        $content = "";
        if (trim($cmd[0])=="100"){
            $rid = $this->exe_sql_one("select roomid from bg_user where extid='".$from."'");
            $sg = $this->exe_sql_one("select name from bg_stage where id=".trim($cmd[1]));
            $sqls = array();
            array_push($sqls,"update bg_game set stage='".trim($cmd[1])."' where roomid='".$rid[0]."' and live='存活'");
            array_push($sqls,"update bg_room set stage='".trim($cmd[1])."' where roomid='".$rid[0]."'");
            if (0 == $this->task($sqls)){
                $content = "房间状态为【".$sg[0]."】";
            }
            else{
    ...
    private function command_101($from,$cmd){
        $content = "";
        if (trim($cmd[0])=="101"){
            $rid = $this->exe_sql_one("select roomid from bg_user where extid='".$from."'");
            $death = $this->exe_sql_one("select name from bg_death where id=".trim($cmd[2]));
            $sg = $this->exe_sql_one("select stage from bg_room where roomid='".$rid[0]."'");
            if (0 == $this->task(array("update bg_game set live='".$death[0]."',stage='".$sg[0]."' where roomid='".$rid[0]."' and seatid=".$cmd[1]))){
                $content = "座位【".$cmd[1]."】,死亡类型为【".$death[0]."】,阶段【".$sg[0]."】";
            }
            else{
                $content = "死亡状态设置失败";
            }
    ...
    private function command_102($from,$cmd){
        $content = "";
        if (trim($cmd[0])=="102"){
            $content = "";
        }
    ...
    private function execmd($key,$from){
        $cmd = explode(' ',trim($key));
        $content = "";
        foreach($this->godcommands as $cmds){
            $content = call_user_func(array($this,$cmds),$from,$cmd);
            if ("" != $content){
                break;
            }
        }
