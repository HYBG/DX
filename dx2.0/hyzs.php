...
<?php
    ...
    echo "<div>";
    if (count($prev)>0){
        echo "<h2><a href=\"hyzs.php?date=".$prev[0]."\">prev</a></h2>";
    }
    echo "<h2 id=\"H2\"></h2>";
    if (count($next)>0){
        echo "<h2><a href=\"hyzs.php?date=".$next[0]."\">next</a></h2>";
    }
    echo "</div>";
?>
...
<?php
    ...
    foreach($codes as $code){
        ...
        if ($data[0][0]>$data[0][1]){
            ...
            if ($close>$data[0][2] and $yc<$data[1][2] and $zdf>0.02 and $score>55 and $score<85){
